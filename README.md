...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Competent-Devs.github.io/react_movies-list-filter-js/) and add it to the PR description.
